    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('cadangansg/create') }}">Tambah</a>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <table class="table-bordered table-striped table-hover table-sm table" id="table_cadangansg">
                <thead>
                    <tr>
                        <th>no</th>
                        <th>Jarak</th>
...
<script>
    $(document).ready(function() {
        var dataTable = $('#table_cadangansg').DataTable({
            serverSide: true,
            ajax: {
                "url": "{{ url('cadangansg/list') }}",
                "type": "POST",
                "data": function(d) {
                    d._token = '{{ csrf_token() }}';
