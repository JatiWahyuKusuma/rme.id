    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('vendorsg/create') }}">Tambah</a>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <table class="table-bordered table-striped table-hover table-sm table" id="table_vendorsg">
                <thead>
                    <tr>
                        <th>no</th>
                        <th>Jarak(km)</th>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            var dataLevel = $('#table_vendorsg').DataTable({
                serverSide: true,
                ajax: {
                    url: "{{ url('vendorsg/list') }}",
                    type: "POST",
                    data: function(d) {
