    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('ghopoven/create') }}">Tambah</a>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <table class="table-bordered table-striped table-hover table-sm table" id="table_ghopoven">
                <thead>
                    <tr>
                        <th>no</th>
                        <th>Jarak(km)</th>
