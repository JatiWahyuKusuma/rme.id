    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('cadanganghopo/create') }}">Tambah</a>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <table class="table-bordered table-striped table-hover table-sm table" id="table_cadanganghopo">
                <thead>
                    <tr>
                        <th>no</th>
                        <th>Jarak</th>
...
<script>
    $(document).ready(function() {
        var dataTable = $('#table_cadanganghopo').DataTable({
            serverSide: true,
            ajax: {
                "url": "{{ url('cadanganghopo/list') }}",
                "type": "POST",
                "data": function(d) {
                    d._token = '{{ csrf_token() }}';
